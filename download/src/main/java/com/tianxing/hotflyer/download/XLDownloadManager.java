package com.tianxing.hotflyer.download;
...
import com.tianxing.hotflyer.download.android.XLLog;
import com.tianxing.hotflyer.download.android.XLUtil;
import com.tianxing.hotflyer.download.android.XLUtil.GUID_TYPE;
import com.tianxing.hotflyer.download.android.XLUtil.GuidInfo;
import com.tianxing.hotflyer.download.parameter.BtIndexSet;
import com.tianxing.hotflyer.download.parameter.BtSubTaskDetail;
import com.tianxing.hotflyer.download.parameter.BtTaskParam;
import com.tianxing.hotflyer.download.parameter.BtTaskStatus;
import com.tianxing.hotflyer.download.parameter.CIDTaskParam;
import com.tianxing.hotflyer.download.parameter.EmuleTaskParam;
import com.tianxing.hotflyer.download.parameter.GetDownloadHead;
import com.tianxing.hotflyer.download.parameter.GetDownloadLibVersion;
import com.tianxing.hotflyer.download.parameter.GetFileName;
import com.tianxing.hotflyer.download.parameter.GetTaskId;
import com.tianxing.hotflyer.download.parameter.InitParam;
import com.tianxing.hotflyer.download.parameter.MagnetTaskParam;
import com.tianxing.hotflyer.download.parameter.MaxDownloadSpeedParam;
import com.tianxing.hotflyer.download.parameter.P2spTaskParam;
import com.tianxing.hotflyer.download.parameter.PeerResourceParam;
import com.tianxing.hotflyer.download.parameter.ServerResourceParam;
import com.tianxing.hotflyer.download.parameter.ThunderUrlInfo;
import com.tianxing.hotflyer.download.parameter.TorrentInfo;
import com.tianxing.hotflyer.download.parameter.UrlQuickInfo;
import com.tianxing.hotflyer.download.parameter.XLConstant;
import com.tianxing.hotflyer.download.parameter.XLConstant.XLManagerStatus;
import com.tianxing.hotflyer.download.parameter.XLProductInfo;
import com.tianxing.hotflyer.download.parameter.XLSessionInfo;
import com.tianxing.hotflyer.download.parameter.XLTaskInfo;
import com.tianxing.hotflyer.download.parameter.XLTaskInfoEx;
import com.tianxing.hotflyer.download.parameter.XLTaskLocalUrl;
